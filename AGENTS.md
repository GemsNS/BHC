...
- **Transfer docs:** `CLAUDE.md` + `docs/CURSOR_BRIEFING.md` (automation master map) + `docs/SYSTEM_OVERVIEW.md` (full architecture map) + `docs/` (HANDOFF, ARCHITECTURE, API, DEPLOYMENT, USAGE, KNOCKER, AI, AUTOMATION, OUTREACH, SETUP_CHECKLIST, WALID_PRESENTATION_DEPLOY).
