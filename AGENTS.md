...
- **Transfer docs:** `CLAUDE.md` + `docs/CURSOR_BRIEFING.md` (master map of the automation platform) + `docs/` (HANDOFF, ARCHITECTURE, API, DEPLOYMENT, USAGE, KNOCKER, AI, AUTOMATION, OUTREACH, SETUP_CHECKLIST).
