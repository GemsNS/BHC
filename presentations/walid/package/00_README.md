...
The main contract uses the provisional calculation of **30 squares × $400 + two doors × $500 + two doors = $13,000.00 before HST (fuel/travel waived)**. Before signature, the Parties should complete every blank and responsibility selection in Schedules A and B, especially the following items.

| Confirmation required | Why it matters |
| --- | --- |
| Legal/registered addresses and signatory titles | Identifies who is legally bound. |
| HST number and whether the $13,000.00 price is before or after HST | Prevents a tax and total-price dispute. |
