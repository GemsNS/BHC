...
Read this document first for system understanding. Then use the focused docs in `docs/` for deep dives. Prefer **code over stale docs** when they conflict — several older files still say “Co.” / store v8 / PIN-only auth.
