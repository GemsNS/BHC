...
import { filterShowcaseByAudience, type ProjectAudience } from "@/lib/site/audience";
import { JOB_SHOWCASE_IMAGES } from "@/lib/site/jobShowcaseImages";
  ...
  const heading =
    audience === "commercial"
      ...
      : {
          ...
          body: "Explore recent BH Contracting LTD. projects across Halifax and Nova Scotia. Every image reflects the same priorities: clean detailing, weather-ready assemblies, and reliable communication.",
        };
