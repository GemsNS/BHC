...
/**
 * Sanitize store for a browser client. When `viewer` is a non-payroll role,
 * other employees' pay rates are zeroed and time entries are limited to the
 * viewer's own punches (staff should not see crew payroll).
 */
