...
export const AUTOMATION_CATALOG: AutomationCatalogEntry[] = [
  ...
  {
    id: "auto-media-offload",
    action: "media_offload",
    name: "Photo storage housekeeping",
    description: "Move inline photos and signatures out of the JSON store into data/media so the store stays small and fast.",
    runHour: 3,
    defaultEnabled: true,
    serverOnly: true,
  },
  {
    ...
    description: "A week after an invoice is paid, text/email the customer a one-tap Google review link (needs REVIEW_URL).",
    runHour: 11,
    defaultEnabled: true,
  },
  {
    id: "auto-referral-asks",
    action: "referral_asks",
    name: "Referral asks",
    description: "Two weeks after a job completes, ask the happy customer for a referral with a tracked link.",
    runHour: 11,
    defaultEnabled: true,
  },
  {
    ...
    description: "Friendly reminders to customers with sent-but-unpaid invoices at 7, 14 and 30 days, with the pay link.",
    runHour: 10,
    defaultEnabled: true,
  },
  {
    id: "auto-job-reports",
    action: "job_reports",
    name: "Weekly customer job reports",
    description: "Every week, turn the crew's site updates and photos into a PDF progress report per active job and send it to the customer (DOCS_AUTOSEND=job_report) or hold it for your click.",
    runHour: 16,
    defaultEnabled: true,
    serverOnly: true,
  },
  {
    id: "auto-lead-discovery",
    action: "lead_discovery",
    name: "Internet lead discovery",
    description: "Claude searches the web for fresh 'looking for a contractor' posts in your service area and feeds them into the ad inbox.",
    runHour: 0,
    intervalMinutes: 180,
    defaultEnabled: true,
    serverOnly: true,
